          ...
          availableDrones.map(
            (
              ...
              path:
                result.mode ===
                "FORWARD_BASE"
                  ? "Forward Base â†’ Incident"
                  : "Admin Base â†’ Incident",
          ...
          <div style={{ padding: "20px" }}>
            ...
            {directFeasible && (
              ...
              >
                ...
                >
                  ðŸš DEPLOY MAIN SWARM DIRECTLY
                </button>
              ...
              >
                  ...
                  >
                    ...
                    <span>
                      ...
                      deployment.mobile_zone.distance_to_incident_km <= 30
                        ? "âœ“ INSIDE INITIAL ASSESSMENT RANGE"
                        : "â†’ MOVING TO ASSESSMENT RANGE"}
                    </span>
                    <span>INCIDENT</span>
                  </div>
                ...
                {deployment?.mobile_zone?.status ===
                  ...
                  >
                    ...
                    <strong>
                      ðŸ”Ž INITIAL ASSESSMENT RANGE REACHED
                    </strong>
                    ...
                    >
                      ðŸ”Ž DEPLOY INITIAL ASSESSMENT DRONES
                    </button>
              ...
              >
                ...
                >
                  ...
                  <div className="dashboard-card">
                    <p>ESTIMATED AREA</p>
                    <h3>
                      {deployment.recon.disaster_region?.estimated_area_km2 ?? "-"} kmÂ²
                    </h3>
                  </div>
                ...
                {activeOperation.mode === "REAL" && (
                  ...
                  >
                    ...
                    >
                      OPEN OFFICIAL SATELLITE SOURCE â†—
                    </a>
                ...
                >
                  ...
                  {(deployment.recon.drones_deployed || []).map(
                    (id) => (
                      ...
                      >
                        ðŸ”Ž DR-{String(Number(id) + 1).padStart(3, "0")}
                      </span>
                    )
                  )}
